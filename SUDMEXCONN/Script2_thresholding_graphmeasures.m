...
threshold_percentages = 0.1:0.01:0.5; % 10% to 50% in steps of 10%
...
numNodes = size(allCorrMatrices, 1);  % Number of nodes
numParticipants = size(allCorrMatrices, 3);  % Number of participants
numThresholds = 41;      % Assuming you have 5 thresholds per participant
