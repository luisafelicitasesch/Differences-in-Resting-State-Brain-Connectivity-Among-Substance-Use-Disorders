...
for i = 1:numel(measures)
    ...
    for region = 1:size(data.Controls, 1)
        ...
        region_results = table(repmat(region, 3, 1), comparisons, log_bf_values, ...
